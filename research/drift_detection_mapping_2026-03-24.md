...
**Our system mapping:**
- Hidden test directory: `~/.claude/holdouts/` or `C:\apps_ai\OpenBrainLM\.holdouts\` (outside agent view)
...
**Our system mapping:**
- Hook fires PostToolUse → script writes to `C:\apps_ai\logs\agent_audit_trail.jsonl`
