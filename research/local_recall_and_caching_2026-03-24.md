...
- Location: `<WORKSPACE>\.claude\skills\prime.md` or project-level equivalent.
...
| Prior local recall research | <WORKSPACE>\OpenBrainLM\research\agents_arcs_local_recall_2026-03-24.md | Internal | 4-pattern baseline |
